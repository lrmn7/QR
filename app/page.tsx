...
export default function Home() {
  ...
  // Social links
  const twitterLink = 'https://lrmn.is-a.dev';
  const githubLink = 'https://github.com/lrmn7/QR';
    ...
    <>
      ...
      <main className='flex flex-col items-center justify-between p-10 pt-20'>
        ...
        <div className='inputs-wrapper z-30'>
          <div className='flex mb-3 w-full justify-center'>
            {/* Settings Button */}
            <button className='side-button settings-button flex justify-center pb-2 pt-2 pl-2 pr-2 mr-2 border-gray-800 backdrop-blur-2xl rounded-xl border p-4 bg-gray-800/30'>
              <svg
            ...
            {/* Main URL Input */}
            <div className='flex w-full justify-center pb-2 pt-2 border-gray-800 backdrop-blur-2xl static rounded-xl border p-4 bg-gray-800/30'>
              <input
                value={input}
                type='text'
                spellCheck='false'
            ...
            <button
              onClick={() => downloadJpg()}
              className='side-button save-button flex justify-center pb-2 pt-2 pl-2 pr-2 ml-2 border-gray-800 backdrop-blur-2xl static rounded-xl border p-4 bg-gray-800/30'
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
          ...
          <div className='settings border-gray-300 bg-gradient-to-b from-gray-200 pb-2 pt-2 backdrop-blur-2xl dark:border-gray-800 dark:from-inherit static rounded-xl border bg-gray-200 p-4 dark:bg-gray-800/30'>
            <div className='flex items-center justify-between my-2'>
              ...
              <input
                ...
                className='focus:ring-gray-500 h-4 w-4 text-gray-600 border-gray-800 rounded'
              />
            </div>
            ...
            <div className='flex items-center justify-between my-2'>
              ...
              <input
                ...
                className='w-full mx-2 h-5 bg-gray-800/30 outline-none appearance-none border-2 border-gray-800 rounded-full cursor-pointer focus:border-gray-500'
              />
              <span>1000px</span>
            </div>
            ...
            <div className='flex items-center justify-between my-2'>
              ...
              <input
                ...
                ref={fileInputRef}
                className='w-full p-2 border-2 border-gray-800 focus:border-white rounded'
              />
      ...
      <footer className='w-full flex align-center justify-center flex-col mt-10 mb-4'>
        <span className='flex align-center justify-center'>
          <p className='opacity-40'>Made with ♡ by</p>
          <a
